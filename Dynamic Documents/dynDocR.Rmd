...
One of the nice features of a R markdown document is that when *kniting*, the working directory is set automatically to the location of the markdown file, thus making this step unnecessary.
