...
Notice that executing the code chunk above yielded the printing of raw \LaTeX code, which should produce a pretty table. To correct this, I will include the parameter `results='asis'`, which will pass through results without reformatting them.
